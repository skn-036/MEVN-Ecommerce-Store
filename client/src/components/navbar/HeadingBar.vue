<script setup lang="ts">
	import Info from '@/components/navbar/heading-bar/Info.vue';
...
<template>
	<div
		class="container-padding w-full h-[44px] bg-violet flex flex-row justify-between"
	>
		<!-- info -->
		<Info class="md:flex flex-1 hidden" />
