...
<template>
	<div class="container-padding flex flex-col">
		...
		>
			<!-- service card premium quality -->
			<div
				class="rounded-md shadow-lg shadow-slate-300 sha py-10 px-5 flex flex-col"
			>
				<img
